          ...
          <div className="flex items-center gap-3">
            <button 
              ...
              onClick={() => {
                ...
                a.href = url;
                a.download = `mar-report-${new Date().toISOString().slice(0, 10)}.json`;
                a.click();
                URL.revokeObjectURL(url);
              }}
            >
              <Download size={18} className="text-gray-600" />
              <span className="text-sm text-gray-700">Export MAR</span>
            </button>
            <button 
                        ...
                        <div className="relative">
                          ...
                          {openDropdown === med.id && (
                            <div className="absolute right-0 mt-1 w-52 bg-white rounded-xl border border-gray-100 shadow-xl z-20 py-1">
                              ...
                              <button
                                className="w-full flex items-center gap-2.5 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"
                                onClick={() => { console.log('View history', med.id); setOpenDropdown(null); }}
                              >
                                <Clock size={14} className="text-gray-400" />
                                View History
                              </button>
